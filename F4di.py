...
# Don't Mess With Me, The Results Will be Horrible. 
...
"""%s
 ...
 - script name : FUNKAR (ETHICAL HACKER)
...
def banner():
 ...
 © Group%s \n __________       _____.__  \n \____    /____ _/ ____\__| %s> %sZona \n   /     /\\__  \\\   __\|  | %s> %sAkun \n  /     /_ / __ \|  |  |  | %s>%s Facebook [Meta] \n /_______ (____  /__|  |__| %s>%s PASHTUN \n         \/    \/ \n %s[%s*%s] By : %sFadi Funkar \n %s[%s*%s] -------------------------------------- \n [%s*%s] IP : %s%s'''%
                            ...
                            with ThreadPoolExecutor(max_workers=30) as log:
                                ...
                                for akun in self.id:
                                    ...
                                    try:
                                        ...
                                        log.submit(self.basic, pak, Fadi_)
                            ...
                            with ThreadPoolExecutor(max_workers=30) as log:
                                ...
                                for akun in self.id:
                                    ...
                                    try:
                                        ...
                                        log.submit(self.mobil, Pak, Fadi_)
...
def menu():
    ...
    print (' [%s04%s] Crack user name (instagram) '%(K,P))
...
def igg():
	...
	print ("\n%s [%s!%s] Cth nama %s: %sFadi "%(P,M,P,M,K))
